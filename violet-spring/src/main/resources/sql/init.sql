...
/* 密码都是帐号 */
insert into user
values (null, "admin", "$2a$10$wbNQBc2eDoy.s6mX1R2PauyMnwsky2nVlDrzEJDj7sH7B/OUx.a2u", "admin", now());
insert into user
values (null, "guest", "$2a$10$PUIzy5o4/d8AXiIG35G8Au1Iki.hQW9HDSnXLLRJxJne4cwSRK47S", "guest", now());
...
values (null, "查看用户", "user:view");
insert into permission
values (null, "操作用户", "user:edit");
